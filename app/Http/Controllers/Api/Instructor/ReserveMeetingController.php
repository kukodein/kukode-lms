...
class ReserveMeetingController extends Controller
{
    ...
    public function requests(Request $request)
    {
        ...
        return apiResponse2(1, 'retrieved', trans('public.retrieved'), [
            'reserve_meetings' => $reserveMeetings,
            'pending_reserveCount' => $pendingReserveCount,
            'total_reserve_count' => $totalReserveCount,
            'sum_reserve_paid' => $sumReservePaid,
            'active_hours_count' => $activeHoursCount,
            'users_reserved_times' => $usersReservedTimes,
        ]);
    ...
    public function finish($id)
    {
        ...
        if (!empty($ReserveMeeting)) {
            ...
            return apiResponse2(1, 'api.done', trans('api.public.done'));
